...
graph TD
    subgraph ACCESS[Access Channels]
        A1[Outbound IVR - AT Voice API]
        A2[Inbound Hotline - AT Voice API]
        A3[Smart App - React Native]
        A4[USSD - AT USSD API]
    end

    ASR[Khaya AI ASR - audio to English text]
    TRG[DistilBERT Triage - stage prefix + classify]
    ALERT[Africa's Talking SMS + Dashboard Alert]
    DASH[Clinical Dashboard - React + Express + PostgreSQL]
...
The evaluation follows a structured framework organised across four domains: primary clinical outcomes, secondary clinical outcomes, implementation outcomes, and system performance outcomes.
...
Blencowe, H., Campbell, O., Kerac, T., Stafford, R., Tripathi, V., & Filippi, V. (2024). Neglected for too long: Perinatal mental health impacts of stillbirth in low- and middle-income countries. *BJOG: An International Journal of Obstetrics & Gynaecology*, *132*(5), 554-556. https://doi.org/10.1111/1471-0528.18051
