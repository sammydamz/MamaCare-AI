...
INSERT INTO consultations (id, patient_id, patient_name, date, language, symptoms, risk_level, ai_summary, transcript, triggered_referral) VALUES
    ('c001', 'p001', 'Abena Osei', '2026-05-27', 'English', ARRAY['severe headache', 'blurred vision', 'swollen feet'], 'HIGH', 'Patient reports severe headache persisting for 3 days, blurred vision, and noticeable swelling in both feet. Blood pressure reading at 150/95 mmHg. These symptoms are consistent with pre-eclampsia warning signs. Immediate referral recommended.', '[{"text": "Mema wo akye Abena, wo ho te sen nnɛ? Masan ate sɛ wo ti pae wo.", "speaker": "AI"}, {"text": "Me ho nnye koraa. Minya ti pae yi nnansa ni, ɛnna m''ani so repupuw me.", "speaker": "Mother"}, {"text": "Wahu sɛ wo nan ahome/akuku anaa?", "speaker": "AI"}, {"text": "Aane, me nan abobow koraa.", "speaker": "Mother"}, {"text": "Mate aseɛ. Ɛsɛ sɛ wokɔ asopiti ntɛmara na yɛbahwɛ wo ne wo ba no yie.", "speaker": "AI"}]'::jsonb, TRUE),
    ...
    ('c004', 'p004', 'Ama Serwaa', '2026-05-28', 'English', ARRAY['reduced fetal movement', 'severe abdominal pain', 'dizziness'], 'HIGH', 'Patient at 36 weeks reports significantly reduced fetal movement (kick count: 4), severe abdominal pain, and episodes of dizziness. Blood pressure at 160/100 mmHg is critically elevated. URGENT: Immediate emergency referral activated for possible placental abruption.', '[{"text": "Ama, wo ho te dɛn? Ɛyɛ ya paa?", "speaker": "AI"}, {"text": "Me yam repae me paa. Bio nso, me ba no ntutu koraa te sɛ daa no.", "speaker": "Mother"}, {"text": "Ntɛmara, ɛsɛ sɛ wokɔ asopiti sesiaa. Mɛbɔ dawur ama ambulance abɛfa wo.", "speaker": "AI"}]'::jsonb, TRUE),
    ('c005', 'p005', 'Yaa Ansah', '2026-05-24', 'English', ARRAY['mild back pain', 'occasional headaches'], 'MEDIUM', 'Patient at 24 weeks reports mild back pain and occasional headaches. Blood pressure slightly elevated at 135/88 mmHg, warranting closer monitoring. No proteinuria detected. Scheduled for follow-up in 1 week.', '[{"text": "Teekpa Yaa, te oye tɛŋ?", "speaker": "AI"}, {"text": "Minaa hejɔlɛ yɛ mikwɛŋ, eye mipaŋ fioo nso.", "speaker": "Mother"}, {"text": "Eye kpakpa. Hɛɛ mɛni okyɛɛ kɛbashi otsi nyɛŋma loo?", "speaker": "AI"}, {"text": "Hɛɛ, mɛba dɛŋŋ otsi ni baa lɛ mli.", "speaker": "Mother"}]'::jsonb, FALSE),
