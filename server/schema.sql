...
DO $$ BEGIN ALTER TABLE patients ADD COLUMN IF NOT EXISTS user_id VARCHAR(50) REFERENCES users(id); EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE consultations ADD COLUMN IF NOT EXISTS user_id VARCHAR(50) REFERENCES users(id); EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE referrals ADD COLUMN IF NOT EXISTS user_id VARCHAR(50) REFERENCES users(id); EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE action_logs ADD COLUMN IF NOT EXISTS user_id VARCHAR(50) REFERENCES users(id); EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE communications ADD COLUMN IF NOT EXISTS user_id VARCHAR(50) REFERENCES users(id); EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE schedules ADD COLUMN IF NOT EXISTS user_id VARCHAR(50) REFERENCES users(id); EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE notifications ADD COLUMN IF NOT EXISTS user_id VARCHAR(50) REFERENCES users(id); EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
-- Backfill: assign all existing seed data to Sarah (user-001)
